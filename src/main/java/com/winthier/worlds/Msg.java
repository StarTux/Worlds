...
final class Msg {
    ...
    public static void announce(String msg, Object... args) {
        ...
        // WorldsPlugin.getInstance().getLogger().info("[Worlds] " + ChatColor.stripColor(msg));
    }

    public static void info(CommandSender to, String msg, Object... args) {
        to.sendMessage(format("&r[&9Worlds&r] &e") + format(msg, args));
    }

    public static void warn(CommandSender to, String msg, Object... args) {
        to.sendMessage(format("&r[&cWorlds&r] &c") + format(msg, args));
    }
